      ...
      {selectedGame === 0 ? (
        <div className="flex p-4 flex-col">
          ...
          <div className="flex justify-center py-4">
            <button data-difficulty={difficulty === easy} className="border-2 border-r-0 border-black rounded-l-xl bg-gray-200 hover:bg-gray-300 hover:underline p-2 transition-all duration-200 data-[difficulty=true]:bg-sky-400" onClick={() => handleDifficulty(easy)}>Easy</button>
            <button data-difficulty={difficulty === med} className="border-y-2 border-black bg-gray-200 hover:bg-gray-300 hover:underline p-2 transition-all duration-200 data-[difficulty=true]:bg-sky-400" onClick={() => handleDifficulty(med)}>Medium</button>
            <button data-difficulty={difficulty === hard} className="border-2 border-l-0 border-black rounded-r-xl bg-gray-200 hover:bg-gray-300 hover:underline p-2 transition-all duration-200 data-[difficulty=true]:bg-sky-400" onClick={() => handleDifficulty(hard)}>Hard</button>
          </div>
